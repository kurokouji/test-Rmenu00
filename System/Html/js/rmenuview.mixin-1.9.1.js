(function($, $R){
  ...
  App.ViewMixin = {
   ...
   ,initAlertDialog: function() {
      ...
      var data = '<div id= "alertDialog" class="modal hide fade" tabindex="-1" role="dialog">';
      data += '<div id="alertHeader" class="modal-header">';
      data += '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>';
      data += '<h4></h4>';
      data += '<div>';  // alertHeader
      data += '<div id="alertBody" class="modal-body">';
      data += '<p></p></br>';
      data += '<div>';  // alertBody
      data += '<div id="alertFooter" class="modal-footer">';
      data += '<input type="button" class="btn" data-dismiss="modal" aria-hidden="true" value="閉じる" ';
      data += 'default-value="閉じる">';
   ...
   ,onAlertDialog: function(arg) {
      ...
      if (Array.isArray(arg["title"])) {
        $("#alertHeader h4").html(arg["title"].join('<br />'));
      } else {

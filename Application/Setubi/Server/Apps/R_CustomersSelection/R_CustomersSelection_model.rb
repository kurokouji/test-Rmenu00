...
class R_CustomersSelection_model
  ...
  def setSql_R_CustomersSelectionOfSetubi(idname1, idname2 ,genesql_freesql)
    $Mlog.debug("R_CustomersSelection_model") {"setSql_R_CustomersSelectionOfSetubi start"}                  # Logファイル Debug用
    ...
    $Mlog.debug("R_CustomersSelection_model") {"setSql_R_CustomersSelectionOfSetubi end"}                    # Logファイル Debug用
    return "OK"
  end

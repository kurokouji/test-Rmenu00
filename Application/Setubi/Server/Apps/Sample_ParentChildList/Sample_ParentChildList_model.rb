...
class Sample_ParentChildList_model
  ...
  def setSql_Sample_ParentChildListOfSetubi(idname1, idname2 ,genesql_freesql)
    $Mlog.debug("Sample_ParentChildList_model") {"setSql_Sample_ParentChildListOfSetubi start"}                  # Logファイル Debug用
    ...
    $Mlog.debug("Sample_ParentChildList_model") {"setSql_Sample_ParentChildListOfSetubi end"}                    # Logファイル Debug用
    return "OK"
  end

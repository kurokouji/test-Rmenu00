...
class Sample_ParentChildList_view
  ...
  def editサンプル親子一覧リストOfSample_ParentChildListOfSetubi()
    $Vlog.debug("Sample_ParentChildList_view") {"editサンプル親子一覧リストOfSample_ParentChildListOfSetubi start"}
    ...
    $Vlog.debug("Sample_ParentChildList_view") {"editサンプル親子一覧リストOfSample_ParentChildListOfSetubi end"}
    return "OK"
  end

...
class ParallelPrintList_model
  ...
  # PDFファイルを削除する
  def pdfDeleteOfSetubi
    $Mlog.debug("ParallelPrintList_model") {"pdfDeleteOfSetubi start"}                            # Logファイル Debug用
    ...
    $Mlog.debug("ParallelPrintList_model") {"pdfDeleteOfSetubi end"}                              # Logファイル Debug用
    return "OK"
  end

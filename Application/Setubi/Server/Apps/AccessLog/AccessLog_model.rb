...
class AccessLog_model
  ...
  def setSql_AccessLogOfSetubi(idname1, idname2 ,genesql_freesql)
    $Mlog.debug("AccessLog_model") {"setSql_AccessLogOfSetubi start"}                  # Logファイル Debug用
    ...
    $Mlog.debug("AccessLog_model") {"setSql_AccessLogOfSetubi end"}                    # Logファイル Debug用
    return "OK"
  end

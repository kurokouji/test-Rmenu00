...
class ParallelDivisionList_model
  ...
  def writeTupleClientOfSetubi()
    $Mlog.debug("ParallelDivisionList_model") {"writeTupleClientOfSetubi start"}                  # Logファイル Debug用
    ...
    $Mlog.debug("ParallelDivisionList_model") {"writeTupleClientOfSetubi end"}                    # Logファイル Debug用
    return "OK"
  end

...
class Sample_ParentList_model
  ...
  def setSql_Sample_ParentListOfSetubi(idname1, idname2 ,genesql_freesql)
    $Mlog.debug("Sample_ParentList_model") {"setSql_Sample_ParentListOfSetubi start"}                  # Logファイル Debug用
    ...
    $Mlog.debug("Sample_ParentList_model") {"setSql_Sample_ParentListOfSetubi end"}                    # Logファイル Debug用
    return "OK"
  end

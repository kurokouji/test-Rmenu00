...
class Sample_ChildMainte_model
  ...
  def set明細行番号OfSample_ChildMainteOfSetubi()
    $Mlog.debug("Sample_ChildMainte_model") {"set明細行番号OfSample_ChildMainteOfSetubi start"}
    ...
    $Mlog.debug("Sample_ChildMainte_model") {"set明細行番号OfSample_ChildMainteOfSetubi end status = #{emptySW}"}
    return emptySW
  end

...
class R_CustomersList_model
  ...
  def setSql_R_CustomersListOfSetubi(idname1, idname2 ,genesql_freesql)
    $Mlog.debug("R_CustomersList_model") {"setSql_R_CustomersListOfSetubi start"}                  # Logファイル Debug用
    ...
    $Mlog.debug("R_CustomersList_model") {"setSql_R_CustomersListOfSetubi end"}                    # Logファイル Debug用
    return "OK"
  end

...
def main
  begin
    ...
    file_path = $Rconfig['base_application'] + "/Setubi/Json/Apps/BatchDailyReportStart/BatchDailyReportStart_stockconfirm_tran.json"
    out_path  = $Rconfig['base_application'] + "/Setubi/Server/BachProcess/BatchStartup_Sample_result.txt"

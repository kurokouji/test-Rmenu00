(function($, $R){
  ...
  AppSpec.fn.init = function(name) {
    ...
    this.name       = name;
    this.nextname   = "R_MainteServiceHD";
    this.beforename = "";
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Setubi/Html/Apps/R_MainteServiceList/"}
     ,{json: "Setubi/Json/Apps/R_MainteServiceList/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------
   ...
   ,navButtonEvent: [
     ...
     // ここから追加処理
     ,["#保守サービス指示諸掛明細",  "click", "on保守サービス指示諸掛明細"]
   ...
   ,sessionStorageHeaderKey: [
      {
         datasetid: "header"
        ,dataname:  ["検索指示ＮＯ", "検索業者名称", "検索契約ＮＯ", "検索顧客名称", "検索指示日", "検索作業予定日", "検索作業実施日", "検索作業完了フラグ"]
        ,classname: ["検索指示ＮＯ", "検索業者名称", "検索契約ＮＯ", "検索顧客名称", "検索指示日", "検索作業予定日", "検索作業実施日", "検索作業完了フラグ"]
        ,typename:  ["text",         "text",         "text",         "text",         "text",       "text",           "text",           "select"]
      }
    ]
    // ----------------------------------------------------------------------------------
    // 画面明細　キー定義
   ...
   ,nextStorageData: [
      {
         datasetid:   "header"
        ,dataname:    ["検索業者名称",    "検索顧客名称"]
        ,validation:  ["nonrequired",     "nonrequired"]
        ,titlename:   ["検索業者名称",    "検索顧客名称"]
      },
      {
         datasetid:   "detail"
        ,dataname:    ["指示ＮＯ",    "作業区分"]
   ...
   ,beforeStorageData: [
      {
         datasetid: "header"
        ,dataname:  ["検索業者名称", "検索顧客名称", "検索契約ＮＯ"]
        ,classname: ["検索業者名称", "検索顧客名称", "検索契約ＮＯ"]

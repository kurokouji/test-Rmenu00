(function($, $R){
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Setubi/Html/Apps/R_TraderList/"}
     ,{json: "Setubi/Json/Apps/R_TraderList/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------
   ...
   ,sessionStorageHeaderKey: [
      {
         datasetid: "header"
        ,dataname:  ["検索業者名称", "検索郵便番号", "検索住所"]
        ,classname: ["検索業者名称", "検索郵便番号", "検索住所"]

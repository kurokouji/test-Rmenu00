(function($, $R){
  ...
  AppSpec.fn.init = function(name) {
    ...
    this.name       = name;
    this.nextname   = "";
    this.beforename = "R_MainteServiceHD";
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Setubi/Html/Apps/R_MainteServiceHD1/"}
     ,{json: "Setubi/Json/Apps/R_MainteServiceHD1/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------
   ...
   ,pubsubCheckEvent: [
    // ここから追加処理
      ["check単価", "controller", "check単価"]
     ,["check数量", "controller", "check数量"]
    ]

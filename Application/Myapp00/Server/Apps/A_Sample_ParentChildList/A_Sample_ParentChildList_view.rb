...
class A_Sample_ParentChildList_view
  ...
  def editサンプル親子一覧リストOfA_Sample_ParentChildListOfMyapp00()
    $Vlog.debug("A_Sample_ParentChildList_view") {"editサンプル親子一覧リストOfA_Sample_ParentChildListOfMyapp00 start"}
    ...
    $Vlog.debug("A_Sample_ParentChildList_view") {"editサンプル親子一覧リストOfA_Sample_ParentChildListOfMyapp00 end"}
    return "OK"
  end

  # 保守サービス指示一覧表　指示ＮＯ　編集処理
  def editサンプル親子一覧リスト_親子(sqlRecord, responseRecord, i)
    $Vlog.debug("A_Sample_ParentChildList_view") {"editサンプル親子一覧リスト_親子 start"}
    ...
    $Vlog.debug("A_Sample_ParentChildList_view") {"editサンプル親子一覧リスト_親子 end"}
    return "OK"
  end

  # 保守サービス指示一覧表　作業区分　編集処理
  def editサンプル親子一覧リスト_子(sqlRecord, responseRecord, i)
    $Vlog.debug("A_Sample_ParentChildList_view") {"editサンプル親子一覧リスト_子 start"}
    ...
    $Vlog.debug("A_Sample_ParentChildList_view") {"editサンプル親子一覧リスト_子 end"}
    return "OK"
  end

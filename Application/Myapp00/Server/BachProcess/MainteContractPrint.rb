...
def main
  begin
    ...
    file_path = $Rconfig['base_application'] + "/Myapp00/Json/Apps/BatchStartMainteContractPrint/BatchStartMainteContractPrint_startup_tran.json"
    out_path  = $Rconfig['base_application'] + "/Myapp00/Server/BachProcess/MainteContractPrint_result.txt"

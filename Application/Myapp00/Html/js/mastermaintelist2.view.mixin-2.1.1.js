...
(function($, $R){
  ...
  // 関数を追加する
  App.MasterMainteList2ViewMixin = {
    // --------
    // 処理開始
    // --------
   ...
   ,onクリア: function(dataSet) {
    ...
    // -------------------------------------------------------
   ,onメインテーブル照会OfEditResponseData: function(dataSet, responseData, mode) {
      $R.log("View onメインテーブル照会OfEditResponseData : start");
      ...
      $R.log("View onメインテーブル照会OfEditResponseData : end");
    }

(function($, $R){
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Myapp00/Html/Apps/A_Sample_ParentChildMainte/"}
     ,{json: "Myapp00/Json/Apps/A_Sample_ParentChildMainte/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------
   ...
   ,selectStorageRequestData: [
      {
         requestname: "A_Sample_Selection"
        ,datasetid:   ""
        ,dataname:   []
        ,value:      []
      }
   ...
   ,selectStorageResponseData: [
      {
         responsename: "A_Sample_ParentChildMainte"
        ,datasetid:    "header"
        ,dataname:    ["Ａサンプル_マスタＩＤ", "Ａサンプル_マスタ項目１"]
        ,value:       ["",             ""]
   ...
   ,selectbox: [
      {
         ...
         ,init:     {initvalue: "", inithtml: "サンプル_区分選択", datasetid: "選択サンプル_区分", valuename: "選択Ａサンプル_区分ＩＤ", htmlname: "選択Ａサンプル_区分名称"}

(function($, $R){
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Myapp00/Html/Apps/ParallelPrintList/"}
     ,{json: "Myapp00/Json/Apps/ParallelPrintList/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------
   ...
   ,requestInfo: [
     ...
     // ここから追加処理
     ,["print",           "on帳票出力OfCheckRequestData",  "on帳票出力OfEditResponseData",  "onErrorResponseData"]
     ,["delete",          "on帳票削除OfCheckRequestData",  "on帳票削除OfEditResponseData",  "onErrorResponseData"]
    ]
    // --------------------------------------------------

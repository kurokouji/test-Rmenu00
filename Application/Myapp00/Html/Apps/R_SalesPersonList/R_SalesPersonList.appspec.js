(function($, $R){
  ...
  AppSpec.fn.init = function(name) {
    ...
    this.name       = name;
    this.nextname   = "R_SalesPersonMainte";
    this.beforename = "";
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Myapp00/Html/Apps/R_SalesPersonList/"}
     ,{json: "Myapp00/Json/Apps/R_SalesPersonList/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------
   ...
   ,sessionStorageHeaderKey: [
      {
         datasetid: "header"
        ,dataname:  ["検索営業担当者名", "検索索引", "検索摘要"]
        ,classname: ["検索営業担当者名", "検索索引", "検索摘要"]

(function($, $R){
  // 名前空間を設定する
  var App = $R.Application.T_Sample_ParentMainte = {};
  ...
  AppSpec.fn.init = function(name) {
    ...
    this.name       = name;
    this.nextname   = "T_Sample_ChildMainte";
    this.beforename = "T_Sample_ParentList";
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Myapp00/Html/Apps/T_Sample_ParentMainte/"}
     ,{json: "Myapp00/Json/Apps/T_Sample_ParentMainte/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------

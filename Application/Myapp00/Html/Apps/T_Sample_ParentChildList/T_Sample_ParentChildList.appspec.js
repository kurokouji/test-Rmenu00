(function($, $R){
  ...
  AppSpec.fn.init = function(name) {
    ...
    this.name       = name;
    this.nextname   = "T_Sample_ParentChildMainte";
    this.beforename = "";
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Myapp00/Html/Apps/T_Sample_ParentChildList/"}
     ,{json: "Myapp00/Json/Apps/T_Sample_ParentChildList/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------
   ...
   ,sessionStorageHeaderKey: [
      {
         datasetid: "header"
        ,dataname:  ["検索ヘッダ項目１", "検索ヘッダ項目２", "検索Ｔサンプル_マスタ項目０１"]
        ,classname: ["検索ヘッダ項目１", "検索ヘッダ項目２", "検索Ｔサンプル_マスタ項目０１"]

(function($, $R){
  ...
  AppSpec.fn.init = function(name) {
    ...
    this.name       = name;
    this.nextname   = "A_Sample_ChildMainte";
    this.beforename = "A_Sample_ParentList";
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Myapp00/Html/Apps/A_Sample_ParentMainte/"}
     ,{json: "Myapp00/Json/Apps/A_Sample_ParentMainte/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------
   ...
   ,selectStorageResponseData: [
      {
         responsename: "A_Sample_ParentMainte"
        ,datasetid:    "header"

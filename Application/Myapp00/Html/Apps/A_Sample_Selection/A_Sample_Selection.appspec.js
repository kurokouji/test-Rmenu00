(function($, $R){
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Myapp00/Html/Apps/A_Sample_Selection/"}
     ,{json: "Myapp00/Json/Apps/A_Sample_Selection/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------
   ...
   ,sessionStorageHeaderKey: [
      {
         datasetid: "header"
        ,dataname:  ["検索Ａサンプル_マスタ項目１", "検索Ａサンプル_マスタ項目２", "検索Ａサンプル_マスタ項目３"]
        ,classname: ["検索Ａサンプル_マスタ項目１", "検索Ａサンプル_マスタ項目２", "検索Ａサンプル_マスタ項目３"]
   ...
   ,sessionStorageDetailKey: [
      {
         datasetid: "detail"
        ,dataname:  ["Ａサンプル_マスタＩＤ", "Ａサンプル_マスタ項目１", "Ａサンプル_マスタ項目２", "Ａサンプル_マスタ項目３"]

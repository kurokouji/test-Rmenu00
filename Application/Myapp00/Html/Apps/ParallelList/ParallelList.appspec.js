(function($, $R){
  ...
  AppSpec.fn.init = function(name) {
    ...
    this.name       = name;
    this.nextname   = "ParallelDivisionList";
    this.beforename = "";
  ...
  AppSpec.include({
    ...
    // -----------------------------------------------------------------------------------------------
    urlInfo: [
      {app:  "Myapp00/Html/Apps/ParallelList/"}
     ,{json: "Myapp00/Json/Apps/ParallelList/"}
    ]
    // --------------------------
    // JSONファイル情報を定義する
    // --------------------------
   ...
   ,requestInfo: [
     ...
     // ここから追加処理
     ,["delete",  "on処理削除OfCheckRequestData",  "on処理削除OfEditResponseData",  "onErrorResponseData"]
    ]
    // --------------------------------------------------
